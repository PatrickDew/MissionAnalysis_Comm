                    ...
                    <VAR name = "Modulator">
                        <VAR name = "QPSK">
                            <SCOPE Class = "Modulator">
                                ...
                                <VAR name = "Description">
                                    <STRING>&quot;Modulator capable of modulating a signal using QPSK modulation&quot;</STRING>
                                </VAR>
                                <VAR name = "Type">
                                    <STRING>&quot;QPSK&quot;</STRING>
                                </VAR>
...
BEGIN Extensions
    ...
    BEGIN Crdn
		...
		BEGIN	VECTOR
			Type	VECTOR_TOVECTOR
			Name	Communication_Site
			Description	Displacement vector to Communication_Site
				Origin
					BEGIN	POINT
						Type	POINT_LINKTO
						Name	Center
				...
				Destination
					BEGIN	POINT
						Type	POINT_LINKTO
						Name	Center
						RelativePath	Facility/Communication_Site
					END	POINT
				LTDRefSystem
					BEGIN	SYSTEM
						Type	SYSTEM_LINKTO
		...
		BEGIN	VECTOR
			Type	VECTOR_TOVECTOR
			Name	Communication_Site-Uplink_Ka_Rx
			Description	Displacement vector to Communication_Site-Uplink_Ka_Rx
				Origin
					BEGIN	POINT
						Type	POINT_LINKTO
						Name	Center
				...
				Destination
					BEGIN	POINT
						Type	POINT_LINKTO
						Name	Center
						RelativePath	Facility/Communication_Site/Receiver/Uplink_Ka_Rx
					END	POINT
				LTDRefSystem
					BEGIN	SYSTEM
						Type	SYSTEM_LINKTO
			...
			Description	Displacement vector to LOGSAT1101-Downlink_Ka_Tx
				...
				Destination
					BEGIN	POINT
						Type	POINT_LINKTO
						Name	Center
						RelativePath	../../Transmitter/Downlink_Ka_Tx
					END	POINT
				LTDRefSystem
					BEGIN	SYSTEM
						Type	SYSTEM_LINKTO
